...
class _CropGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (grid.isMoving || grid.alwaysShowThirdLines) {
      ...
      // path.addPolygon(
      //     [bounds.topLeft.translate(0, thirdHeight), bounds.topRight.translate(0, thirdHeight)],
      //     false);
      // path.addPolygon([
      ...
      // path.addPolygon(
      //     [bounds.topLeft.translate(thirdWidth, 0), bounds.bottomLeft.translate(thirdWidth, 0)],
      //     false);
      // path.addPolygon(
      //     [bounds.topRight.translate(-thirdWidth, 0), bounds.bottomRight.translate(-thirdWidth, 0)],
      //     false);
    }
